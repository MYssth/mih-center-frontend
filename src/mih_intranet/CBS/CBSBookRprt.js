...
function CBSBookRprt() {
    ...
    const handleFindDate = () => {
        ...
        setFilterSched(allSched.filter(dt => dt.req_date >= tmpFromDate && dt.req_date <= dateFns.format(dateFns.addDays(new Date(toDate), 1), 'yyyy-MM-dd')));
    }
    ...
    const columns = [
        ...
        },
        {
            ...
            minWidth: 100,
            valueGetter: (params) =>
                `${String(new Date(params.row.req_date).getUTCDate()).padStart(2, '0')}/${String(parseInt(new Date(params.row.req_date).getUTCMonth(), 10) + 1).padStart(2, '0')}/${new Date(params.row.req_date).getUTCFullYear()}`,
        ...
        },
        {
            ...
            minWidth: 60,
            valueGetter: (params) =>
                `${String(new Date(params.row.req_date).getUTCHours()).padStart(2, '0')}:${String(new Date(params.row.req_date).getUTCMinutes()).padStart(2, '0')}`
        },
        {
            field: 'status_name',
            headerName: 'สถานะ',
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.rcv_date ?
                    `${String(new Date(params.row.rcv_date).getUTCDate()).padStart(2, '0')}/${String(parseInt(new Date(params.row.rcv_date).getUTCMonth(), 10) + 1).padStart(2, '0')}/${new Date(params.row.rcv_date).getUTCFullYear()}`
                    : "",
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.rcv_date ?
                    `${String(new Date(params.row.rcv_date).getUTCHours()).padStart(2, '0')}:${String(new Date(params.row.rcv_date).getUTCMinutes()).padStart(2, '0')}`
                    : "",
        },
        {
            field: 'permit_name',
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.permit_date ?
                    `${String(new Date(params.row.permit_date).getUTCDate()).padStart(2, '0')}/${String(parseInt(new Date(params.row.permit_date).getUTCMonth(), 10) + 1).padStart(2, '0')}/${new Date(params.row.permit_date).getUTCFullYear()}`
                    : "",
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.permit_date ?
                    `${String(new Date(params.row.permit_date).getUTCHours()).padStart(2, '0')}:${String(new Date(params.row.permit_date).getUTCMinutes()).padStart(2, '0')}`
                    : "",
        },
        {
            field: 'note',
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.dep_date ?
                    `${String(new Date(params.row.dep_date).getUTCDate()).padStart(2, '0')}/${String(parseInt(new Date(params.row.dep_date).getUTCMonth(), 10) + 1).padStart(2, '0')}/${new Date(params.row.dep_date).getUTCFullYear()}`
                    : "",
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.dep_date ?
                    `${String(new Date(params.row.dep_date).getUTCHours()).padStart(2, '0')}:${String(new Date(params.row.dep_date).getUTCMinutes()).padStart(2, '0')}`
                    : "",
        },
        {
            field: 'dep_mi',
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.arr_date ?
                    `${String(new Date(params.row.arr_date).getUTCDate()).padStart(2, '0')}/${String(parseInt(new Date(params.row.arr_date).getUTCMonth(), 10) + 1).padStart(2, '0')}/${new Date(params.row.arr_date).getUTCFullYear()}`
                    : "",
        ...
        },
        {
            ...
            valueGetter: (params) =>
                params.row.arr_date ?
                    `${String(new Date(params.row.arr_date).getUTCHours()).padStart(2, '0')}:${String(new Date(params.row.arr_date).getUTCMinutes()).padStart(2, '0')}`
                    : "",
        },
        {
            field: 'arr_mi',
                                        ...
                                        <Stack direction="row" spacing={10} sx={{ width: 'auto' }}>
                                            <Box>
                                                ...
                                                <Stack direction="row" spacing={1}>
                                                    ...
                                                    <Button variant="contained" sx={{ width: 100 }} onClick={handleFindSchedId} >ค้นหา</Button>
                                                </Stack>
                                            </Box>
                                            <Box>
