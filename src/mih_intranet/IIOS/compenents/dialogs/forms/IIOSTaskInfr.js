...
function IIOSTaskInfr({ openDialg, onCloseDialg, data, auditId }) {
  ...
  return (
    <>
      <Dialog fullWidth maxWidth="md" open={openDialg} onClose={onCloseDialg}>
        ...
        <DialogContent>
          <DialogContentText>คุณต้องการตรวจรับงานนี้ใช่หรือไม่</DialogContentText>
          <TextField
            id="auditComment"
            name="auditComment"
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleInformerTaskComment}>
            บันทึกหมายเหตุ
          </Button>
          <Button variant="contained" onClick={handleInformerTask}>
            ยืนยันการตรวจรับงาน
          </Button>
        </DialogActions>
      </Dialog>
