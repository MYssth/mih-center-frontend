                        ...
                        <Autocomplete
                            ...
                            options={
                                levelId === "DMIS_IT" ?
                                    ...
                                    : levelId === "DMIS_MT" ? Object.values(operList).map((option) => option.level_id === "DMIS_MT" || option.level_id === "DMIS_ENV" ? `${option.personnel_firstname} ${option.personnel_lastname}` : "").filter(isSkip)
