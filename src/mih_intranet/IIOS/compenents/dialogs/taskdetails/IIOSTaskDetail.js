        ...
        <>
            ...
            >
                ...
                <DialogContent>
                    <Box sx={{ flexGrow: 1 }}>
                        <Grid container spacing={1}>
                            ...
                            <Grid item xs={8}>
                                <Item>{data?.level_id === "DMIS_IT" ? "IT" : (data?.level_id === 'DMIS_MT' ? "ซ่อมบำรุง" : "เครื่องมือแพทย์")}</Item>
                            </Grid>
                            <Grid item xs={4}>
                                <Item sx={{ textAlign: 'right' }}>วันที่แจ้ง:</Item>
                            </Grid>
                            <Grid item xs={8}>
                                <Item>{data?.task_date_start ? (data?.task_date_start).replace("T", " ").replace(".000Z", " น.") : ""}</Item>
                            </Grid>
                            <Grid item xs={4}>
                            ...
                            <Grid item xs={8}>
                                <Item>{data?.informer_firstname} {data?.informer_lastname}</Item>
                            </Grid>
                            <Grid item xs={4}>
                            ...
                            <Grid item xs={8}>
                                <Item>{data?.task_date_accept ? (data?.task_date_accept).replace("T", " ").replace(".000Z", " น.") : ""}</Item>
                            </Grid>
                            <Grid item xs={4}>
                            ...
                            <Grid item xs={8}>
                                <Item>{data?.receiver_firstname} {data?.receiver_lastname}</Item>
                            </Grid>
                            <Grid item xs={4}>
                                <Item sx={{ textAlign: 'right' }}>วันที่ดำเนินการล่าสุด:</Item>
                            </Grid>
                            <Grid item xs={8}>
                                <Item>{data?.task_date_process ? (data?.task_date_process).replace("T", " ").replace(".000Z", " น.") : ""}</Item>
                            </Grid>
                            <Grid item xs={4}>
                                <Item sx={{ textAlign: 'right' }}>ผู้รับผิดชอบ:</Item>
                            </Grid>
                            <Grid item xs={8}>
                                <Item>{data?.operator_firstname} {data?.operator_lastname}</Item>
                            </Grid>
                            <Grid item xs={4}>
                            ...
                            <Grid item xs={8}>
                                <Item>{data?.task_date_end ? (data?.task_date_end).replace("T", " ").replace(".000Z", " น.") : ""}</Item>
                            </Grid>
                            <Grid item xs={4}>
                ...
                <DialogActions>
                    ...
                    <Button onClick={() => { reportPDF(data) }}>ปริ้นเอกสาร</Button>
                </DialogActions>
            </Dialog>
        </>
    )
