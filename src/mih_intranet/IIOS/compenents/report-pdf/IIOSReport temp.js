          ...
          body: [
            ...
            [{
              text: [
                ...
                `วันที่แจ้ง: ${dateFns.format(dateFns.subHours(dateFns.addYears(new Date(data.task_date_start), 543),7), 'dd/MM/yyyy')}\n`,
      ...
      '\n',
      {
        ...
        table: {
          ...
          body: [
            ...
            [{
              text: [
                `สถานะ: ${(data.task_iscomplete === null || data.task_iscomplete === "") ? data.status_name : data.status_id === 5 || data.status_id === 0 ? data.status_name : data.status_id === 3 ? `ดำเนินการเสร็จสิ้น (เปลี่ยนอะไหล่)` : `ดำเนินการเสร็จสิ้น (${data.status_name})`}\t`,
