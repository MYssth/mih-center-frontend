      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
          ...
          {showDMIS ? (
            <>
              <Grid item xs={4}>
                <Button variant="contained" onClick={handleDMIS}>
                  {' '}
                  <Icon icon="ic:baseline-settings-suggest" width="50" height="50" />
          ...
          {showDSMS ? (
            <>
              <Grid item xs={4}>
                <Button variant="contained" onClick={handleDSMS}>
                  <Icon icon="fa6-solid:user-doctor" width="50" height="50" />
                  ระบบจองเวรแพทย์
                </Button>
              </Grid>
            </>
          ...
          <Grid item xs={4}>
            <Button variant="contained" onClick={handleIntranet}>
              <Icon icon="material-symbols:fiber-new-outline" width="50" height="50" />
              หน้าระบบภายในใหม่
            </Button>
          </Grid>
        </Grid>
